...
$count = mysql_num_rows($retval);
	...
	echo"<form action='deathInfo.php' method='POST'>";
	
	echo "<tr><td>Death Reason</td><td><textarea rows=”100” cols=”300” name='death_reason'></textarea></td></tr>";
	echo "<tr><td>Treatment</td><td><textarea rows=”100” cols=”300” name='treatment'></textarea></td></tr>";
	echo "<tr><td>Death date</td><td><input type='text' name='death_date' placeholder='date'></td></tr>";
	echo "<tr><td>Death time</td><td><input type='text' name='death_time' placeholder='time'></td></tr>";
    
	echo "<input type='hidden' name='p_id' value='$p_id'>";
	
    echo "<tr><td>Bill</td><td><input type='text' name='bill' placeholder='bill'></td></tr>";
