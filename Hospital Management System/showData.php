...
<table align="center" bgcolor="majenda" border="1" width="60%" height="50%">
	...
	<hr>
     <p><font face="arial" color="Green" size="+1">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Patient at Present in Hospital</font></p>
...
$sql_1 = "SELECT * FROM p_admission WHERE status = 1 AND p_dept= '$deptName[$i]'";
...
echo "<tr><th>name</th><th>age</th><th>gender</th><th>Dept</th><th>Bed No.</th><th>Admission date</th><th>Complication</th></tr>";
    if($count == 0){
		...
		echo "<tr><td>$name</td><td>$age<td>$gender</td><td>$dept</td><td>$bed_no</td><td>$admission_date</td><td>$p_complication</td></tr>";
